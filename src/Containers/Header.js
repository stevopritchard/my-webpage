    ...
    return (
        <div className={classes.root}>
            <AppBar position="fixed" style={{ background: 'transparent', boxShadow: 'none', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)'}}>
                <Toolbar>
                    <Grid item xs={2} sm={2} md={2} style={{display:'flex', flexFlow:'row nowrap', justifyContent: 'flex-start'}}>
                    ...
                    <Box />
                    <Grid item xs={8} sm={8} md={8} style={{display:'flex', flexFlow:'row nowrap', justifyContent: 'center'}}>
                        <Button 
                    ...
                    <Grid item xs={2} sm={2} md={2} style={{display:'flex', flexFlow:'row nowrap', justifyContent: 'flex-end'}}>
                        <IconButton
                            style={props.darkMode ? {color:'#fff', paddingRight: 0, paddingLeft: '8px'} : {color:'rgba(0, 0, 0, 0.87)', paddingRight: 0, paddingLeft: '8px'}}
