...
const frontEndCourses = [
  createFEData(
    'Complete Web Developer: Zero to Mastery (Udemy)',
    '',
    <CheckIcon style={{ height: 13, width: 13 }} />,
    <CheckIcon style={{ height: 13, width: 13 }} />,
    <CheckIcon style={{ height: 13, width: 13 }} />
  ),
    ...
    <Table>
      <TableHead>
        <TableRow>
          <TableCell></TableCell>
          <TableCell>
            <FontAwesomeIcon icon={faHtml5} size="sm" />
          </TableCell>
          <TableCell>
            <FontAwesomeIcon icon={faCss3} size="sm" />
          </TableCell>
          <TableCell>
            <FontAwesomeIcon icon={faJs} size="sm" />
          </TableCell>
          <TableCell>
            <FontAwesomeIcon icon={faReact} size="sm" />
          </TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
    ...
    <Table>
      <TableHead>
        <TableRow>
          ...
          <TableCell>
            <SvgIcon viewBox="0 0 70 40" style={{ height: 20, width: 20 }}>
              <Expressjs />
            </SvgIcon>
          </TableCell>
          <TableCell>
            <SvgIcon viewBox="0 -8 58 43" style={{ height: 18, width: 18 }}>
              <Postgresql />
            </SvgIcon>
          </TableCell>
          <TableCell>
            <SvgIcon viewBox="0 -5 50 40" style={{ height: 19, width: 19 }}>
              <Mongodb />
            </SvgIcon>
          </TableCell>
        </TableRow>
  ...
  return (
    <Container className={classes.mainArea} fixed>
      ...
      <Typography variant="body1" align="center">
        Creative and proactive Full Stack Developer currently supporting
        multiple projects across Lloyd's Banking Group's Chief Customer Office.{' '}
        {<br />}
      </Typography>
      <Typography variant="body1" align="justify">
        My passion is to make interactions easier for end-users, colleagues, and
        the business by developing solutions that are accessible, fast and that
        empower users by being easy to use. I want to bring my skillset to your
        development team and help to build the great things that you are working
        on in JavaScript.
      </Typography>
      <Box
        display="flex"
        ...
        <Grid container spacing={2}>
          ...
          >
            <Button
              ...
              variant="outlined"
            >
              <Typography style={{ fontSize: '0.7em', fontWeight: 500 }}>
                See the rest of my skills...
              </Typography>
            </Button>
          </Grid>
          <Grid
